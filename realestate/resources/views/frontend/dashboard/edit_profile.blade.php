                            ...
                            <div class="lower-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="showImage" src="{{ (!empty($userData->photo)) ? url('upload/user_images/'.$userData->photo) : url('upload/no_image.jpg') }}" alt="profile') }}" alt=""style="width:100px; height: 100px;"></a></figure>
